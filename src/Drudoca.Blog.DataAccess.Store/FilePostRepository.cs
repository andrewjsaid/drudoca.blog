...
namespace Drudoca.Blog.DataAccess.Store
{
    ...
    {
        private readonly IMarkdownStore<PostData> _blogPostStore;

        public FilePostRepository(IMarkdownStore<PostData> blogPostStore)
        {
        ...
        {
            var posts = await _blogPostStore.GetAllAsync();
            return posts.Length;
        }
